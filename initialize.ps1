...
Write-Verbose "Replacing 'Applications' with '$PackageName' in all files..."
Write-Verbose "Also replacing 'Applications' with '$($PackageName.ToLower())' in all files..."
...
function ProcessFile {
    ...
    try {
        ...
        if ($content -match "Applications") {
            $content = $content -replace "Applications", $PackageName
            $hasChanges = $true
        }
        
        if ($content -match "Applications") {
            $content = $content -replace "Applications", $PackageName.ToLower()
            $hasChanges = $true
        }
...
Rename-ProjectItems -SearchPattern "Applications" -Replacement $PackageName -ItemType Directory
Rename-ProjectItems -SearchPattern "Applications" -Replacement $PackageName -ItemType File
Rename-ProjectItems -SearchPattern "Applications" -Replacement $PackageName.ToLower() -ItemType Directory
Rename-ProjectItems -SearchPattern "Applications" -Replacement $PackageName.ToLower() -ItemType File
...
Write-Output "Package name has been changed from 'Applications' to '$PackageName'"
Write-Output "Lowercase 'Applications' has been changed to '$($PackageName.ToLower())'" 