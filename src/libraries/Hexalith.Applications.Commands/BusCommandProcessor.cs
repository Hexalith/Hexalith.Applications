...
namespace Hexalith.Applications;
...
public class BusCommandProcessor : IDomainCommandProcessor
{
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="bus"/> or <paramref name="dateTimeService"/> is null.</exception>
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="command"/> or <paramref name="metadata"/> is null.</exception>
